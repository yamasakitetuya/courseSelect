  ...
  <div class="panel-body">
    	<form class="form-horizontal" role="form" method="post"  action="${pageContext.request.contextPath}/teacher?action=save" onsubmit="return checkForm()" >
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-10">
			      <input type="text" class="form-control" id="teaNo"  name="teaNo" style="width: 300px;"  value="${teacher.teaNo }">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-10">
			      <input type="text" class="form-control" id="status"  name="status" style="width: 300px;"  value="${teacher.status }">
		    </div>
		  </div>
		  <div class="form-group">
