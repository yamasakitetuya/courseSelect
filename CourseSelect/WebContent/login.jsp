...
<div class="container-fluid">
  <div class="navbar-header">
    <a class="navbar-brand" href="http://www.chd.edu.cn/">CHD</a>
  </div>
  <div>
    <ul class="nav navbar-nav">
    	<li class="dropdown">
    		...
    		<ul class="dropdown-menu">
    			<li><a id="studentRegister" href="/Xsxk/user?action=register&registerRole=student">学生</a></li>
    			<li><a id="teacherRegister" href="/Xsxk/user?action=register&registerRole=teacher">教师</a></li>
    		</ul>	
    	...
    	<li class="dropdown">
    		...
    		<ul class="dropdown-menu">
    			<li><a id="studentRegister" href="/Xsxk/user?action=findPassword&registerRole=student">学生</a></li>
    			<li><a id="teacherRegister" href="/Xsxk/user?action=findPassword&registerRole=teacher">教师</a></li>
    		</ul>	
    	</li>   
    </ul>
  </div>
					...
					<TR>
						<td>
							<select id="userType" name="userType" class="input" style="margin-top: 15px;height: 24px">
								...
								<option value="manager"  ${'manager'==user.userType?'selected':'' }>管理员</option>
								<option value="teacher"  ${'teacher'==user.userType?'selected':'' }>教师</option>
								<option value="student"  ${'student'==user.userType?'selected':'' }>学生</option>
							</select>
						</td>
					</TR>
				</TBODY>
