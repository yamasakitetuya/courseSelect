  ...
  <div class="col-md-6">
	<form action="${pageContext.request.contextPath}/student?action=list" method="post">
	    <div class="input-group" style="width: 300px">
		      <input type="text" class="form-control" name="s_userName"  value="${s_student.trueName }" placeholder="请输入要查询的用户姓名...">
		...
		<tr>
		  ...
		  <c:forEach var="student" items="${studentList }" varStatus="status">
		  	<tr>
		  		...
		  		<td>
		  			<button type="button" class="btn btn-info btn-xs" onclick="javascript:window.location.href='${pageContext.request.contextPath}/student?action=preSave&id=${student.id }'">修改</button>&nbsp;
		  			<button type="button" class="btn btn-danger btn-xs" onclick="studentDelete(${student.id })">删除</button>
		  		</td>
		  	</tr>
		  </c:forEach>
	</table>
