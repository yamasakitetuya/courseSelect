  ...
  <div class="panel-body">
    	<form class="form-horizontal" role="form" method="post"  action="${pageContext.request.contextPath}/course?action=save" onsubmit="return checkForm()" >
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-10">
		    	<input type="text" class="form-control" id="courseTime"  name="courseTime" style="width: 300px;"  value="${course.courseTime }">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-10">
		    	<input type="text" class="form-control" id="classroom"  name="classroom" style="width: 300px;"  value="${course.classroom }">
		    </div>
		  </div>
