...
<div class="list-group">
  ...
  <c:if test="${ currentUser.userType=='管理员'}">
	  ...
	  <a href="${pageContext.request.contextPath}/course?action=list" class="list-group-item">排课信息管理</a>
	  <a href="${pageContext.request.contextPath}/course?action=foundationCourseList" class="list-group-item">课程基础信息</a>
